class runner {
  ...
  scan(){
    ...
    // scan for nutrients. steer away from extant tendrils.

    // decide converge/diverge/step
    if(random() > 0.92 && this.thickness > 16){
        this.diverge();
    }
  ...
  diverge(){
        ...
        const pos1 = p5.Vector.add(this.pos, p5.Vector.fromAngle(this.dir + 0.5*PI, this.thickness * thickness_ratio * 0.5));
        const pos2 = p5.Vector.add(this.pos, p5.Vector.fromAngle(this.dir - 0.5*PI, this.thickness * (1-thickness_ratio) * 0.5));
        runners.push(new runner(
            pos1.x,
            pos1.y,
            this.dir,
