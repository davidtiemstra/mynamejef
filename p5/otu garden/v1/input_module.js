...
function setup_input_module(){
    ...
    next_phase_button.position(x_1, y_1 + (FABRICS.length+1)*y_margin)
    next_phase_button.mousePressed(() => input_phase_done = true); // probably this should be a function that validates the inputs before continuing
}
